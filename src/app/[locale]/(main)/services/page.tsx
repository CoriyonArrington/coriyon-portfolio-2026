...
import { Block as ServicesBlock } from "@/components/blocks/services/services-grid/block"
  ...
  return (
    <Stack gap="0" w="full">
      ...
      {localizedServices && localizedServices.length > 0 && (
        // FIX: Swapped from bg.subtle to bg.canvas
        <Box id="services" py={{ base: "16", md: "24" }} bg="bg.canvas" borderTopWidth="1px" borderBottomWidth="1px" borderColor="border.subtle">
          <Container maxW="7xl" px={{ base: "4", md: "8" }}>
            <FadeIn>
      ...
      {homeContent.process?.steps && homeContent.process.steps.length > 0 && (
