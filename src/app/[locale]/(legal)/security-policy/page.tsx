...
export async function generateMetadata(
  ...
  const pageData = await getPageData('security-policy')
  
  const title = pageData?.[`title_${currentLocale}`] || pageData?.title || 'Security Policy | Coriyon Arrington'
  const description = pageData?.[`meta_description`] || 'How I secure your data and protect your information.'
        ...
        <Container maxW="7xl" px={{ base: "4", md: "8" }}>
          <FadeIn>
            <CenteredHeroLayout 
              ...
              title={isEs ? (pageData?.title_es || "Política de Seguridad") : (pageData?.title || "Security Policy")}
              description={isEs ? "Cómo protejo su información y mantengo la confianza." : "How I protect your information and maintain trust."}
              pb={{ base: "12", md: "16" }}
            />
          </FadeIn>
        </Container>
